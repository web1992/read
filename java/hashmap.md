...
我们这里把新的数组分成两部分，`旧数组`和`新数组`（只是为了方便理解），如下图:
...
hashmap 中数组的长度都是2的n次方,如：$2^3=8$,而2的n次方的结果，这个的数字的二进制有一个特点，就是有效位高位是1，低位都是0，如8的二进制是1000
...
hash=10 oldCap =8 newCap=16

1010 & 01000

1010 & 10000

而 (1010 & 10000) - (1010 & 01000) = 01000 = oldCap

所以 (1010 & 01000) = oldCap +  (1010 & 01000)

即 (1010 & 01000) = j + oldCap
